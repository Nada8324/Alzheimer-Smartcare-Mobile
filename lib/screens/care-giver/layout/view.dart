...
class CareGiverLayoutScreen extends StatelessWidget {

  final CareGiverLayoutController controller = Get.put(CareGiverLayoutController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CareGiverLayoutController>(
      builder: (controller) {
        return AppScreen(
          extendBody: true,
